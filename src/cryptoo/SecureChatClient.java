...
public class SecureChatClient extends JFrame {
...
private final JTextField tfHost = new JTextField("127.0.0.1");
    ...
    private final JTextField tfNick = new JTextField("Client-" + (int)(Math.random()*1000));
    ...
    public SecureChatClient() {
        super("Şifreli Sohbet (Swing) — Client");
        buildUI();
        bindActions();
    ...
    // ------- yardımcılar (etiket üstte, kutu altta) -------
    ...
    private void buildUI() {
        ...
        connRow.add(labeled(" ", btnConnect)); // buton için boş başlık
    ...
    private void bindActions() {
        ...
        tfMessage.addActionListener(e -> sendMessage(true)); // Enter -> şifreli gönder (kolaylık)
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new SecureChatClient().setVisible(true));
    }

    // ---- Wire mesajı (basit ayraclı format)
